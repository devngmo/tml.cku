...
class StaticLogger {
    companion object {
        private var excludeMap: HashMap<String, String> = HashMap()
        ...
        private var enableLogClasses: MutableList<String> = ArrayList()
        @Suppress("MemberVisibilityCanBePrivate")
        ...
        fun printConfig() {
            logStreamer?.I(
                curAppTag!!, "StaticLogger", "Show debug: $showDebug")
        }
    }
}